...
import 'package:purewaterapp/sign_in_page.dart';
...
class SignUpPageState extends State<SignUpPage> {
    ...
    Widget _buildPasswordTextField() {
      return TextFormField(
        ...
        validator: (val) =>
        val.length < 8 ? 'Your password is too Password too short..' : null,
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    child: Text("Sign In", style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 18.0),
                    ),
                  ),
                ],
              ),
